...
st.sidebar.markdown("## 📆 Selecciona tu día")
dia = st.sidebar.slider("Día de práctica", 1, 9, 1)

st.markdown(f"## {guia_9_dias[dia]['titulo']}")
st.markdown(guia_9_dias[dia]['contenido'])

st.success("✨ Lee este paso con calma. Reflexiona o escríbelo en tu diario si deseas. Puedes volver a este día cuantas veces quieras.")
